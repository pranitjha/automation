module.exports = {
  ...
  'Check 403 Access Denied Page': function (browser) {
    ...
    const nonExistentUrl = browser.globals.application_url + '/admin'; // Replace with the path that should redirect

    // Define a part of the text or a unique element on your 404 page
    const errorText = 'Access denied'; // Replace this with actual text or an element on your 404 page
    ...
    browser
      ...
      .assert.textContains('h2', errorText, 'The page title contains Not Found message.')

      // If your 404 page has a unique CSS class or id, you can use that for a more accurate test
      .assert.visible('.pnf__btn.coh-style-link-button-color', 'The error 404 search element is visible on the page.')
