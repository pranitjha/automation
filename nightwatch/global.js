module.exports = {
  ...
  // Your Drupal credentials can be stored as environment variables
  application_url: 'https://sitename.com',
  url_without_https: 'sitename.com',
  adminUsername: 'xyz',
  adminPassword: 'xyz',
  userEmail: 'xyz@acquia.com',
